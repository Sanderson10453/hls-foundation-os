...
def main():
    ...
    config_path = os.path.abspath(
                os.path.join(
                    os.getcwd(), '../', './Work + Internship Materials/Consulting/GullahGeechee/Prithvi-100M-sen1floods11/sen1floods11_Prithvi_100M.py'))
    ckpt = os.path.abspath(
                os.path.join(
                    os.getcwd(), '../',
                    './Work + Internship Materials/Consulting/GullahGeechee/Prithvi-100M-sen1floods11/sen1floods11_Prithvi_100M.pth'))
    input_type = 'tif'
    input_path = os.path.abspath(
                os.path.join(
                    os.getcwd(), '../', './Work + Internship Materials/Consulting/GullahGeechee/Gullah-Geechee/HLS_Images/Experienced_Flood_Days/Composite/'))
    output_path = os.path.abspath(
                os.path.join(
                    os.getcwd(), '../', './Work + Internship Materials/Consulting/GullahGeechee/Gullah-Geechee/HLS_Images/Experienced_Flood_Days/Composite/Processed_Images/Sept1_Run/'))
    bands = 13
    device = 'cpu'
    ...
    inference_on_files(
        config_path, ckpt, 
        input_type,
         input_path, output_path, bands, device
    )
